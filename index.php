...
<head>
    ...
    <title>Главная – Charm</title>
</head>
<body>
    <h1>Кошелёк Charm</h1>
    <p>Charm – это онлайн-кошелёк, позволяющий вам производить хранить и управлять своими денежными средствами.</p>
    <p>Регистрация абсолютно бесплатна и доступна каждому. <a href="register.php">Зарегистрируйтесь</a> 
    уже сегодня али <a href="login.php">войдите</a> в свой аккаунт, коли он у вас уже есть.</p>
    <footer>
